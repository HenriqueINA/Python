...
print(lista_anos[:20])
print(lista_anos[20:])
print(lista_anos.index(1923)) # Descobrir a posição do numero na lista "lista_anos"
print(lista_anos[lista_anos.index(1937):lista_anos.index(1970)])
...
lista1.remove(2) #remove o 2 da lista
lista1.clear() #remove todos os elementos da lista
nomes.remove("Ana") #remove a "Ana" da lista