...
def jogo():
    ...
    # Criação das naves
    nave1 = NaveModelo("Falcão", cores["vermelho"], 20, "F")
    nave2 = NaveModelo("Estrela", cores["azul"], 15, "E")
    nave3 = NaveEspecial("Cometa", cores["verde"], 10, "C", 30)
    ...
    while True:
        ...
        tabuleiro_proxima = criar_tabuleiro()
        ...
        for nave in naves:
            if isinstance(nave, NaveEspecial):
                ...
                print(f"{nave.simbolo} - {nave.denominacao} - Energia: {nave.energia}")
        ...
        exibir_tabuleiros_rodada(tabuleiro_oculto, tabuleiro_tiros, tabuleiro_proxima)
